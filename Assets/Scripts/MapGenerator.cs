...
>>>>>>> 56156329b687026873d0f6ecc9b76878d52e077d
    ...
    public void DrawMapInEditor()
    {
        ...
        else if (drawMode == DrawMode.Mesh)
        {
            ...
            display.DrawMesh(MeshGenerator.GenerateTerrainMesh(mapData.heightMap, meshHeightMultiplier, meshHeightCurve, editorPreviewLOD), TextureGenerator.DrawTextureFromColorMap(mapData.colorMap, mapChunkSize, mapChunkSize));
        }
    }
